  ...
  return (
    <>
      <div
        ...
        className={` fixed flex items-center rounded-lg justify-start gap-[1rem] -translate-x-[50%] md:translate-x-0 left-[50%]  md:left-[90%]  bottom-[2rem] text-[#FDF9EF] text-sm transition-all duration-300 ease-in-out z-[4000] p-[6px]
